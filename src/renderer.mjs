...
function draftPayload(){if(!record||!pdf)return null;return {key:record.key,id:record.id,pdf:pdfPath,signature,baseIssues:record.hasIssues,baseConcerns:record.concerns,baseReviewed:record.qcReviewed,decision:$('decision').value,concerns:$('concerns').value,reviewer:$('reviewer').value,checked:[...checked],pageNumber,pageFindings:[...pageFindings],pendingCorrections:[...pendingCorrections],exportedCorrections:[...exportedCorrections],viewRotations:[...viewRotations],exportedRotations:[...exportedRotations],dirty};}
